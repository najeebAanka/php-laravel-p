<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item basic-nav-item">
            <a class="nav-link collapsed" href="{{ url('dashboard/store-services'.'/'.Route::input('id')) }}">
                <i class="bi bi-card-checklist"></i>
                <span>Store Services</span>
            </a>
        </li><!-- End F.A.Q Page Nav -->
        <li class="nav-item basic-nav-item">
            <a class="nav-link collapsed" href="{{ url('dashboard/store-orders'.'/'.Route::input('id')) }}">
                <i class="bi bi-receipt"></i>
                <span>Store Orders</span>
            </a>
        </li><!-- End F.A.Q Page Nav -->
        <li class="nav-item basic-nav-item">
            <a class="nav-link collapsed" href="{{ url('dashboard/store-profile'.'/'.Route::input('id')) }}">
